...
public class OrdersAfterSaleService {
    ...
    @AdminAuth(name = "添加订单售后", orderNum = 2)
    @ExplainOperation(name = "添加订单售后", notes = "添加订单售后信息", params = {
    ...
    public JsonResult add(String params) {
        try {
            OrdersAfterSale obj = JSONObject.toJavaObject(JSON.parseObject(params), OrdersAfterSale.class);
            ordersAfterSaleDao.save(obj);
    ...
    @AdminAuth(name = "修改订单售后", orderNum = 3)
    @ExplainOperation(name = "修改订单售后", notes = "修改订单售后信息", params = {
            @ExplainParam(value = "id", name = "订单售后id", require = true, type = "int", example = "1"),
            @ExplainParam(value = "...", name = "其他信息", type = "Object", example = "对应其他数据")
    }, back = {
    ...
    public JsonResult update(String params) {
        try {
            OrdersAfterSale o = JSONObject.toJavaObject(JSON.parseObject(params), OrdersAfterSale.class);
            OrdersAfterSale obj = ordersAfterSaleDao.findOne(o.getId());
    ...
    @AdminAuth(name = "删除订单售后", orderNum = 4)
    @ExplainOperation(name = "删除订单售后", notes = "通过ID删除对象", params = {
    ...
    public JsonResult delete(String params) {
        try {
            Integer id = Integer.parseInt(JsonTools.getJsonParam(params, "id"));
            OrdersAfterSale r = ordersAfterSaleDao.findOne(id);
            ordersAfterSaleDao.delete(r);
